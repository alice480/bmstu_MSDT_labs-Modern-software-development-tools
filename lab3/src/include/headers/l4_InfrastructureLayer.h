#ifndef _INCLUDE_INFRASTRUCTURE_LAYER_H
#define _INCLUDE_INFRASTRUCTURE_LAYER_H
...
template <typename T> T readNumber(std::istream &is) {
  T result;
...
template <typename T> void writeNumber(std::ostream &os, T i) {
...
#endif // _INCLUDE_INFRASTRUCTURE_LAYER_H
